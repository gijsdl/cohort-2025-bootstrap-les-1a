...
<!--        <a class="navbar-brand" href="index.php">Bedrijfsnaam</a>-->
...
<!--    <div class="row">-->
<!--        <div class="col-sm-12 col-md-6 col-lg-3 me-5 bg-primary text-danger">-->
<!--            <p class="w-75 bg-secondary fs-2">Col 1</p>-->
<!--        </div>-->
<!--        <div class="col-sm-12 col-md-6 col-lg-3 bg-danger">Col 2</div>-->
<!--    </div>-->
<!--</div>-->
